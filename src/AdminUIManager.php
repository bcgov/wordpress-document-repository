...
class AdminUIManager {
    ...
    public function enqueue_admin_scripts( string $hook ): void {
        ...
        if ( 'toplevel_page_' . $this->config->get( 'menu_slug' ) === $hook ) {
            wp_enqueue_script( 'wordpress-document-repository-app' );
        } else {
            wp_enqueue_script( 'wordpress-document-repository-metadata-app' );
        }
    ...
    private function register_admin_scripts(): void {
        ...
        wp_register_script(
            'wordpress-document-repository-app',
            $build_url . '/document-repository/index.js',
        ...
        wp_register_script(
            ...
            $build_url . '/metadata-settings/index.js',
    ...
    public function localize_scripts( string $hook ): void {
        ...
        wp_localize_script(
            'toplevel_page_' . $this->config->get( 'menu_slug' ) === $hook ? 'wordpress-document-repository-app' : 'wordpress-document-repository-metadata-app',
    ...
    public function render_repository_page(): void {
        ...
        echo '<div id="wordpress-document-repository-app"></div>';
        echo '</div>';
    }
    ...
    public function render_metadata_settings_page(): void {
        ...
        echo '<div id="wordpress-document-repository-metadata-app"></div>';
        echo '</div>';
    }
}
